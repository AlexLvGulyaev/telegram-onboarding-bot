...
Промпт разделён на два слоя ответственности. Это главное архитектурное решение: пользовательский слой редактируется нетехническим специалистом, технический слой принадлежит коду.
...
## 🆕 9. Как добавить новую версию промптов
...
**Статус:** as-built; активная версия промптов v1
